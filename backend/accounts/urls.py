...
urlpatterns = [
    ...
    path('api/admin/patients/', api_views.admin_patients_api),
    path('api/parent/dashboard/', api_views.parent_dashboard_api),
    ...
    path('api/doctors/', api_views.public_doctors_api, name='api_public_doctors'),
    ...
    path('api/update-profile/', api_views.update_profile_api, name='api_update_profile'),
    path('api/delete-account/', api_views.delete_account_api, name='api_delete_account'),
]
